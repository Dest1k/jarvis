...
def _planner_system() -> str:
    return (
        ...
        "• РАЗЛИЧАЙ ВВОД ТЕКСТА и НАЖАТИЕ КНОПОК/КЛАВИШ — это РАЗНОЕ:\n"
        "  – paste_text/type_text — вставить ТЕКСТ в ТЕКСТОВОЕ поле (Блокнот, поле "
        "ввода, редактор). НЕ для кнопок!\n"
        "  – «понажимай кнопки», «нажми X», клики по интерфейсу — это инструмент "
        "gui (UI-TARS реально кликает мышью по кнопкам). Для калькулятора «нажми "
        "кнопки» — это gui, а НЕ paste_text последовательности цифр.\n"
        "  – клавиатурные клавиши/сочетания в активном окне — send_keys.\n"
        ...
        "• «Что на экране/рабочем столе», «что открыто», «прочитай, что показано» — "
        "инструмент see_screen (скриншот + описание зрением). НЕ угадывай по списку "
        "процессов — ПОСМОТРИ инструментом see_screen и опиши реально увиденное.\n"
        ...
        "• Калькулятор: если просят «понажимай кнопки/нажми» — это gui (визуальные "
        "клики по кнопкам). Если просто «посчитай» — send_keys keys='4*4=' "
        "(калькулятор принимает клавиатуру) или инструмент calculator. "
        "paste_text для калькулятора НЕ годится (вставит цифры как текст «мимо»).\n"
