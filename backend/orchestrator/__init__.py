...
_NATIVE_MANDATE = (
    ...
    "Если текущих инструментов недостаточно или рутина повторяется — не имитируй "
    "возможность, а создай новый проверяемый CLI-навык через skill_compile, запусти "
    "его через skill_run и внеси результат в дальнейший план. Инструменты должны "
    "быть универсальными, параметризуемыми и пригодными для повторного запуска. "
